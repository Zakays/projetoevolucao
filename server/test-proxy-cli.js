#!/usr/bin/env node
// Interactive test client to POST to local AI proxy and show the response
// Usage: node server/test-proxy-cli.js
// Optional: set PROXY_URL env var to override, e.g. PROXY_URL=http://127.0.0.1:3001/api/ai node server/test-proxy-cli.js
...
run().catch((e) => { console.error('Fatal error:', e && e.message); process.exit(1); });
